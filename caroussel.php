<div id="slides" class="carousel  slide carousel-fade" data-bs-ride="carousel">
    ...
    <div class="carousel-inner">
        <div class="carousel-item active">
            <img src="images/jorge.jpg" class="d-block w-100 " alt="kk">
        ...
        <div class="carousel-item">
            <img src="images/chooseclotheevencovid.jpg" class="d-block w-100" alt="choose">
            <div class="carousel-caption d-block">
        ...
        <div class="carousel-item">
            <img src="images/hold-bags.jpg" class="d-block w-100" alt="bags">
            <div class="carousel-caption d-block">
